...
Defaults: `SIWX_DOMAIN=localhost`, `SIWX_ADDR=:8080`.
...
3. Open http://localhost:8080, click **Sign in with Phantom (Solana)**.
...
2. Open http://localhost:8080, click **Sign in with MetaMask (Ethereum)**.
...
|---------|---------|-------------|
| `SIWX_DOMAIN` | `localhost` | Expected domain in sign-in messages |
| `SIWX_ADDR` | `:8080` | Listen address |
| `SIWX_JWKS_URL` | `http://localhost:8080/.well-known/jwks.json` | JWKS URL for JWT middleware |
